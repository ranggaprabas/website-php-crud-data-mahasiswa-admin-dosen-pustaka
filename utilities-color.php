<?php
// cek session user dan pass kalo sudahhabis atau hilang akan dibalikkan ke halaman login
session_start();
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFormulir" class="collapse" aria-labelledby="headingFormulir"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Login Screens:</h6>
                        <a class="collapse-item" href="formd.php">Form Dosen</a>
                        <a class="collapse-item" href="form.php">Form Mahasiswa</a>
