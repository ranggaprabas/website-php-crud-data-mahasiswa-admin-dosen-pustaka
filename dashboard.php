...
// include ('koneksi.php');
// cek session user dan pass kalo sudahhabis atau hilang akan dibalikkan ke halaman dashboard
session_start();
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Daftar Pustaka Collapse Menu -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFormulir" class="collapse" aria-labelledby="headingFormulir"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDaftarpustaka"
                    aria-expanded="true" aria-controls="collapseDaftarpustaka">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Formulir Daftar Pustaka</span>
                </a>
                <div id="collapseDaftarpustaka" class="collapse" aria-labelledby="headingDaftarpustaka"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mt-4 p-5 bg-primary text-white rounded justify-content-center">
