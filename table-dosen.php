            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="table-dosen.php">Dosen</a>
                        ...
                        <script>
                            $(document).ready(function() {
                                $("a:nth-child(2)").click(function() {
                                    ...
                                    $(".modal-body").text("Apakah Anda yakin hapus data nip " + nip + "?");
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                        <div class="col-md-12 text-right">
                                            <a href="dosen.php" type="button" class="btn btn-primary"><i class="fas fa-plus"></i>Tambah</a>
                                        </div>
                                    </div>
                                    <br>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $q = mysqli_query($koneksi, "SELECT nip,gelar_depan,nama,gelar_belakang,alamat,tlp FROM dosen ORDER BY nip ASC");
